  ...
  _createClass(Validator, [{
    ...
    value: function validateAfter(event) {
      ...
      if (!this.isValid) {
        ...
        $el.parentElement.querySelector('.error-message').innerHTML = this.options.errorMessage; // field.style.backgroundColor = 'red';
      } else {
        $el.classList.remove('invalid');
        $el.parentElement.querySelector('.error-message').innerHTML = ''; // field.style.backgroundColor = '';
      }
    }
  }]);
